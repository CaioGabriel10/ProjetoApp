...
$c = array("formatacao","limpeza","assistencia tecnica","troca de peca");
...
for($i = 1; $i<=101;$i++){
	echo "(".$i.", 'Cliente".$i."', 'cliente".$i."@gmail.com', '".rand(1000,9999)."', '2016-".rand(1,12)."-".rand(1,30)."', '2016-10-14 17:04:07'),<br>" ;
}
?>